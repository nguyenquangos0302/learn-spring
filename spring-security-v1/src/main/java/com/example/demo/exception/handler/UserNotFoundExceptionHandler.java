...
public class UserNotFoundExceptionHandler {
    ...
    public ResponseEntity<ObjectResult<ExceptionResponse>> handlerUserException(UserException e, WebRequest webRequest) {
        ...
        objectResult.setMessage(MessageConstant.USER_NOT_FOUND);
